...
import time
import random
from generator import load_board
pygame.font.init()


class Grid:
    list_choice = ['easy','Medium','hard']
    board = load_board(random.choice(list_choice))
    ...
    def place(self, val):
        ...
        if self.cubes[row][col].value == 0:
            ...
            if isValid(self.model, val, (row,col)) and self.solve():
                return True
            else:
                ...
                if event.key == pygame.K_RETURN:
                    ...
                    if board.cubes[i][j].temp != 0:
                        if board.place(board.cubes[i][j].temp):
                            ...
                            strikes += 1
                            if (strikes > 5):
                                # count as fail if wrong answer gives more than five times
                                print("Game failed")  
                                main()
                        key = None
